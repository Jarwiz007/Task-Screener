...
//	}
	...
	public void getdata() {
		try {
			...
			PreparedStatement ps=con.prepareStatement("Select title,create_datetime,assigned_to,department,priority,"
					+ "task_type,due_date,customer,status from taskdata where id=?");
